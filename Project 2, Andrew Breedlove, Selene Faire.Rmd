...
For feature similarities, we also use Opendoor's list as a guide, which lists type of home, year built, number of bedrooms, bathrooms and square footage. We will used House Style for type of home, limit our the number of bedrooms and bathrooms to above ground, and use both lot and livable area for square footage. 
