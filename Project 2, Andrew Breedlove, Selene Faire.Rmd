...
# Filter to only houses built after 1950
ames.working <- ames %>% filter(Year_Built >= 1950)
...
ames.working <- ames %>% filter(Neighborhood == "Stone_Brook" | Neighborhood == "Somerset" | Neighborhood == "Northridge_Heights" | Neighborhood == "Bloomington_Heights" | Neighborhood == "Northridge")
