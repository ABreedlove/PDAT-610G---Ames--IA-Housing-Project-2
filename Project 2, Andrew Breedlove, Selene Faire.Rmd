...
ggplot() +
  geom_point(data = ames.transf, aes(Bathroom_AvbGr, Sale_Price, color = Neighborhood)) +
...
4d. Neighborhood Comps: Location
For location or placement as opendoor.com calls it, we have decided to look at a couple more variables, namely MS Zoning, Land Countour, Land Slope, and Condition 1 or proximity to variuos conditions such as arterial or feeder streets, railroads, or off-site features such as parks, greenbelts, etc.
